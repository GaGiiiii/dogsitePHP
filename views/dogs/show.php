          ...
          <div class="collapse navbar-collapse" id="main-menu">
            <ul class="nav navbar-nav navbar-right">
              ...
              <?php if (isset($_SESSION['username'])) { ?>
                ...
                <li name="logout">
                  <!-- <button type="submit" name="logout"> --><span></span><a href="<?php echo ROOT_URL; ?>/views/dogs/index.php?logout='1'" class="register">Logout</a><!-- </button> -->
                </li>
              <?php } else { ?>
              ...
              <div id="tab1">
                ...
                <div class="text-content">
                      ...
                      <li>
                        <form id="likes-dislikes" method="POST" style="display: inline;">
                          ...
                          <button type="submit" name="dislike" value=" " class="dislike-input" id="dislike"><i class="fa fa-thumbs-down <?php if ($disliked) echo 'disliked'; ?>"></i></bitton><span id="display-dislikes"><?php echo $breed['dislikes']; ?></span>
                            ...
                            <!-- <input type="submit" name="like" value=" " class="like-input" id="like"><span id="display-likes"><?php // echo $breed['likes']; 
                                                                                                                                  ?></span> -->
                            <!-- <input type="submit" name="dislike" value=" " class="dislike-input" id="dislike"><span id="display-dislikes"><?php  // echo $breed['dislikes']; 
                                                                                                                                              ?></span> -->
                  ...
                  <?php if (($_SESSION['username'] && $_SESSION['id'] == $breed['user_id']) || $isAdmin) { ?>
                    <a class="btn btn-xs btn-warning show-a" href="<?php echo ROOT_URL; ?>/views/dogs/edit.php?id=<?php echo $breed['id']; ?>">Edit</a>
