        ...
        <form class="form-contact" id="form-contact" method="POST">
          ...
          <div class="row">
            <div class="message-default-col col-md-7">
              <div class="error-default">
                <?php
                if (isset($notMatchingPasswords) && $notMatchingPasswords) { ?>
          ...
          <div class="row">
            <div class="passwordconfirmRL col-md-7">
              <input class="input-contact" type="password" name="passwordconfirm" id="passwordconfirm" placeholder="Confirm Password" value="">
            </div>
          </div>
